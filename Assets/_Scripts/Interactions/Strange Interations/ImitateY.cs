...
public class ImitateY : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (_useImitationRange)
            ...
            {
                _isWithinRange = true;
                // Move towards the target's Y position
                Vector3 newPosition = new Vector3(_objectPosition.x, _imitationPosition.y, _objectPosition.z);
            ...
            else
            {
                ...
                Vector3 newInitialPosition = new Vector3(_objectPosition.x, _initialPosition.y, _objectPosition.z);
    ...
    private void OnDrawGizmos()
    {
        ...
        // Draw line from this object to the target
        Gizmos.color = Color.cyan;
        Gizmos.DrawLine(_objectPosition, new Vector3(_objectPosition.x, _imitationPosition.y, _objectPosition.z));
